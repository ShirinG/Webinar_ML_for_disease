...
\note{
	We could also test all possible combinations of parameters with Cartesian Grid or exhaustive search, but RGS is much faster when we have a large number of possible combinations and usually finds sufficiently accurate models.
...
\begin{frame}[plain, c]
	...
	\begin{itemize}
		...
		\item choose performance measure based on your specific problem
		\item choose prediction threshold based on your specific problem
	\end{itemize}
...
\begin{frame}[plain, c]
	...
	Slides and code will be available on Github: \href{https://github.com/ShirinG/Webinar_ML_for_disease}{https://github.com/ShirinG/Webinar\_ML\_for\_disease/share} \\
